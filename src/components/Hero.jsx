      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold text-dark-navy mb-4">Sonia Uwitonze</h1>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#contact" className="bg-gold text-black px-8 py-3 rounded-full font-semibold hover:bg-blue/90 transition-all transform hover:scale-105 shadow-lg shadow-gold/30">
                Start a Project
              </a>
            ...
            <div className="flex gap-4 mt-8">
              <a href="https://github.com/Uwitonzesonia" target="_blank" rel="noreferrer" className="p-2 bg-gray-100 rounded-full hover:bg-gold/20 transition-colors"><Github size={22} className="text-dark-navy" /></a>
              <a href="https://www.linkedin.com/in/uwitonze-sonia/" target="_blank" rel="noreferrer" className="p-2 bg-gray-100 rounded-full hover:bg-gold/20 transition-colors"><Linkedin size={22} className="text-dark-navy" /></a>
